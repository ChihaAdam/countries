...
function Nav() {  
  ...
  return (
    <div className="font-nunito bg-[var(--light-mode-bg)] dark:bg-[var(--dark-mode-bg)] min-h-screen flex flex-col max-sm:gap-2
                   text-[var(--light-mode-text)] dark:text-white transition-all duration-300 ease-in-out"> 
      <div className="  flex justify-between bg-white dark:bg-[var(--dark-mode-elements)] py-4
        ...
        <div className="flex gap-4 items-center justify-center max-sm:gap-2">
            {darkMode ? <IoMoonSharp className=" text-lg cursor-pointer" onClick={toggleDarkMode} /> : 
                        <IoMoonOutline className="text-lg cursor-pointer"  onClick={toggleDarkMode} />}
