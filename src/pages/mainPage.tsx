  ...
  return (
    <>
      ...
      {error ? (
        ...
        <main
          className="grid grid-cols-4 max-xl:grid-cols-3 max-lg:grid-cols-2 max-md:grid-cols-1
                         mt-10 items-center justify-items-center gap-10"
        >
